...
return [
    ...
    */
    ...
    'between' => [
        ...
        'string' => 'يجب أن يحتوي حقل :attribute على ما بين :min و :max أحرف.',
    ],
    ...
    'date_equals' => 'يجب أن يكون حقل :attribute تاريخًا مساوياً لـ :date.',
    ...
    'password' => [
        ...
        'uncompromised' => 'لقد تم تسريب :attribute المحدد في اختراق بيانات. يرجى اختيار :attribute مختلف.',
    ],
    ...
    */
    ...
    'custom' => [
        'gender' => [
            'in' => 'يرجى اختيار جنس صالح.',
        ],
        'ethnicity' => [
            'in' => 'يرجى اختيار عرق صالح.',
        ],
        'hometown' => [
            'in' => 'يرجى اختيار مسقط رأس صالح.',
        ],
        'country' => [
            'in' => 'يرجى اختيار بلد صالح.',
        ],
        'city_inside_syria' => [
            'in' => 'يرجى اختيار مدينة صالحة.',
            'required_if' => 'المدينة مطلوبة عندما يكون البلد سوريا.',
        ],
        'education_level' => [
            'in' => 'يرجى اختيار مستوى تعليمي صالح.',
        ],
        'source_of_income' => [
            'in' => 'يرجى اختيار مصدر دخل صالح.',
        ],
        'health_status' => [
            'in' => 'يرجى اختيار حالة صحية صالحة.',
        ],
        'religious_affiliation' => [
            'in' => 'يرجى اختيار انتماء ديني صالح.',
        ],
        'marital_status' => [
            'in' => 'يرجى اختيار حالة اجتماعية صالحة.',
        ],
        'other_nationalities.*' => [
            'in' => 'واحدة أو أكثر من الجنسيات المحددة غير صالحة.',
        ],
        'languages.*' => [
            'in' => 'واحدة أو أكثر من اللغات المحددة غير صالحة.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        // العنوان
        'country' => 'البلد',
        'city_inside_syria' => 'المدينة في سوريا',

        // الإحصاء
        'middle_name' => 'اسم الأب',
        'religious_affiliation' => 'الانتماء الديني',
        'other_nationalities' => 'الجنسيات الأخرى',
        'city' => 'المدينة',
        'address' => 'العنوان',
        'shelter' => 'حالة المأوى',
        ...
        'estimated_monthly_income' => 'الدخل الشهري التقديري',
        'number_of_dependents' => 'عدد المعالين',
        'health_status' => 'الحالة الصحية',
        'health_insurance' => 'التأمين الصحي',
        'easy_access_to_healthcare_services' => 'سهولة الوصول إلى الخدمات الصحية',
