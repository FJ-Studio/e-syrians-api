...
<html xmlns="http://www.w3.org/1999/xhtml" dir="{{ in_array($userLocale, ['ar', 'ku']) ? 'rtl' : 'ltr' }}">
                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 0 rgba(0,0,150,.025), 2px 4px 0 rgba(0,0,150,.015); margin: 0 auto; width: 570px;">
                                <tr>
                                    <td class="content-cell" style="padding: 32px;">
                                        ...
                                        {{-- Greeting --}}
                                        <h1 style="font-size: 22px; font-weight: 700; color: #111827; margin: 0 0 6px;">{{ __('mail.newsletter_greeting') }}</h1>
                                        <p style="color: #6b7280; font-size: 15px; margin: 0 0 28px; line-height: 1.5;">{{ __('mail.newsletter_intro') }}</p>

                                        {{-- ── Polls ── --}}
                                        @if($polls->isNotEmpty())
                                        <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom: 16px;">
                                            <tr>
                                                <td style="font-size: 14px; font-weight: 700; color: #6b7280; text-transform: uppercase; letter-spacing: 0.08em; padding-bottom: 10px; border-bottom: 2px solid #e5e7eb;">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom: 20px; border: 1px solid #e5e7eb; border-radius: 8px;">
                                            {{-- Poll question --}}
                                            <tr>
                                                <td style="padding: 16px 18px 12px; background-color: #fafafa; border-radius: 8px 8px 0 0;">
                                            ...
                                            {{-- Vote CTA --}}
                                            <tr>
                                                <td style="padding: 0 18px 16px; background-color: #fafafa; border-radius: 0 0 8px 8px;">
                                        ...
                                        {{-- Sign-off --}}
                                        <p style="color: #718096; font-size: 16px; margin-top: 28px; line-height: 1.5;">
